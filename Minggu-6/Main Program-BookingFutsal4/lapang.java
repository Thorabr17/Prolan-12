public class lapang extends booking{
    ...
    @Override
    public String geNamapenyewa() {
        return super.getNamapenyewa();
    }

    @Override
    public int getNomerlapang() {
        return super.getNomerlapang();
    }
    ...
    @Override
    public void setNomerlapang(int nomerlapang) {
        super.setNomerlapang(nomerlapang);
    }
